...
namespace lemon{namespace unittest{namespace cxx{
	...
	public:
		...
		ConditionException(const char * message,const LemonErrorInfo & errorCode)
		...
		~ConditionException() throw(){}
	        ...
	        const LemonErrorInfo & ErrorCode() const{return _errorCode;}
	...
	class TestCase : private nocopyable
	{
	protected:
	...
	class TestSuite : private nocopyable
	{
	public:
...
namespace{\
	lemon::unittest::cxx::TestCaseFactory<TestCaseName> __object_##TestCaseName##_factory(#TestSuiteName,#TestCaseName);\
}\
void TestCaseName::Run()

#define LEMON_CHECK(condition) lemon::unittest::cxx::Check((bool)(condition),"condition check error --> "#condition,__FILE__,__LINE__)
